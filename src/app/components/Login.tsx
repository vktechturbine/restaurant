    ...
    <div className="xl:w-[60%] md:w-[90%] flex border-4 border-orange-600 p-4">
      ...
      <div className="w-[100%] pl-4 pr-4 ">
        ...
        <form action="">
          ...
          <button className={shown?" mt-6 w-[100%] bg-orange-400 rounded-md p-2":" mt-6 w-[100%] bg-green-400 rounded-md p-2"} type="submit">Submit</button>
        </form>
        <Link href="/register"><button className={shown?"mt-2 w-[100%] bg-green-400 rounded-md p-2":" mt-2 w-[100%]  bg-orange-400 rounded-md p-2"} onMouseEnter={() => setIsShown(true)} onMouseLeave={() => setIsShown(false)}>Register</button></Link>
      </div>
    </div>
  </div>
  )
