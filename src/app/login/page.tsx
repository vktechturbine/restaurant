...
const page = () => {
  return (
    <div className="flex justify-center mt-10">
      <div className="w-[60%] flex border-4 border-orange-600 p-4">
        <div className="w-[100%]">
        ...
        <div className="w-[100%] pl-4 pr-4 ">
          ...
          <button className="hover:bg-orange-400 mt-2 w-[100%]  bg-purple-400 rounded-md p-2"><Link href="/register"  >Register</Link></button>
        </div>
      </div>
    </div>
  );
